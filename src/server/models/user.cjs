...
let User = new Schema({
  ...
  github_user: { type: Boolean, default: false },
  primary_email: { type: String, required: true, index: { unique: true } },
  first_name: { type: String, default: "" },
  last_name: { type: String, default: "" },
  city: { type: String, default: "" },
  hash: { type: String }, // optional (github users don't have passwords)
  salt: { type: String }, // optional (github users don't have passwords)
...
User.method("authenticate", function (plainText) {
  if (this.github_user) return true;
